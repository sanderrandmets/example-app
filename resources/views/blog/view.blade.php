                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div>
                        ...
                        <form action="{{ route('comment.add') }}" method="post">
                            ...
                            <x-textarea class="block-md-1 w-full text-black" name="body"></x-textarea>
                            <button class="px-4 py-2 mt-1 pg-blue-500 rounded text-blue-200">Add</button>
                        </form>
                    </div>

                    <div>
                        @foreach($post->comments as $comment)
                            <div class="my-1 p-4 border border-blue-200 dark:border-white rounded bg-blue-200 dark:bg-gray-700">
                                {{ $comment->body }}
                            </div>
                        @endforeach
                    </div>
